...
public class PRACTICING extends  Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        raa.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
        ...
        seen.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
        ...
        laam.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                Intent intent1 = new Intent(PRACTICING.this,laam.class);
                startActivity(intent1);
                return false;
            }
        });
        kaaf.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                Intent intent1 = new Intent(PRACTICING.this,kaaf.class);
                startActivity(intent1);
                return false;
            }
        });
        qaaf.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                Intent intent1 = new Intent(PRACTICING.this,qaaf.class);
                startActivity(intent1);
                return false;
            }
        });
        geem.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                Intent intent1 = new Intent(PRACTICING.this,geem.class);
                startActivity(intent1);
                return false;
            }
        });
