...
public class qaaf extends  Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView fish = (ImageView) findViewById(R.id.qamarbtn);
        ImageView chair = (ImageView) findViewById(R.id.saqrbtn);
        ImageView sun = (ImageView) findViewById(R.id.waraqbtn);
