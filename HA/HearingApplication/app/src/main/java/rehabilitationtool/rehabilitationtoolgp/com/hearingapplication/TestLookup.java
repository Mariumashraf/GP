...
public class TestLookup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layout.setBackgroundColor(Color.parseColor("#FF9DCEC1"));
        layout.setOrientation(LinearLayout.VERTICAL);
        layout.setPadding(0, 40, 16, 16);

        TextView textview = new TextView(this);
        textview.setText("نتائج الأختبارات");
        ...
        if (allSavedTests.length < 2) {
            ...
            for (int i = 0; i < allSavedTests.length; i++) {
                if (allSavedTests[i].equals("CalibrationPreferences")) {
                    ...
                    b.setBackgroundResource(R.color.cardview_light_background);
                    ...
                    String name ="وقت الأختبار"+ time + ", " + names[2].replaceAll("_", ".") ;
                    b.setText(name);
