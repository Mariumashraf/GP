    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        above.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                aboveplayer.start();
                globalv.addmImageUrls(R.drawable.aboveeeee);
        ...
        below.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                belowplayer.start();
                globalv.addmImageUrls(R.drawable.underrrz);
        ...
        beside.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                besideplayer.start();
                globalv.addmImageUrls(R.drawable.beeesideee);
        ...
        around.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                aroundplayer.start();
                globalv.addmImageUrls(R.drawable.arounddddd);
        ...
        between.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                betweenplayer.start();
                globalv.addmImageUrls(R.drawable.betttweennn);
        ...
        inside.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                insideplayer.start();
                globalv.addmImageUrls(R.drawable.insideeez);
        ...
        right.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                rightplayer.start();
                globalv.addmImageUrls(R.drawable.rightttz);
        ...
        left.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                leftplayer.start();
                globalv.addmImageUrls(R.drawable.leftttz);
