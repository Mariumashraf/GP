    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        kitchen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                kitchenplayer.start();
                globalv.addmImageUrls(R.drawable.kitchennz);
        ...
        company.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                companyplayer.start();
                globalv.addmImageUrls(R.drawable.companyzz);
        ...
        bedroom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                bedplayer.start();
                globalv.addmImageUrls(R.drawable.bedrrroommm);
        ...
        bathroom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                pathplayer.start();
                globalv.addmImageUrls(R.drawable.bathroomz);
        ...
        livingroom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                livingplayer.start();
                globalv.addmImageUrls(R.drawable.livingroommmz);
        ...
        school.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                schoolplayer.start();
                globalv.addmImageUrls(R.drawable.schoollz);
        ...
        supermarket.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                superplayer.start();
                globalv.addmImageUrls(R.drawable.supermarkeetz);
        ...
        university.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                globalv.addmImageUrls(R.drawable.universityyz);
