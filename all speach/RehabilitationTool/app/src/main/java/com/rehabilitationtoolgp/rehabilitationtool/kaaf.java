...
public class kaaf extends  Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button roman = (Button) findViewById(R.id.ketabbtn);
        Button tree = (Button) findViewById(R.id.maktabbtn);
        Button rock = (Button) findViewById(R.id.cakebtn);
    ...
    private void processResult(String command) {
        ...
        if (this.view1.getId() == R.id.ketabbtn) {
            ...
            if (command.indexOf("كيك") != -1) {

                final MediaPlayer bravoplayer = MediaPlayer.create(kaaf.this, R.raw.bravo);
                bravoplayer.start();


            } else if (command.indexOf("كيك") == -1) {
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.ketabbtn || v.getId() == R.id.maktabbtn ||  v.getId() == R.id.cakebtn) {
            ...
            if (kaaf.view1.getId() == R.id.ketabbtn) {
                final MediaPlayer romanplayer = MediaPlayer.create(kaaf.this, R.raw.book);
                romanplayer.start();
            }
            ...
            if (kaaf.view1.getId() == R.id.cakebtn) {
                final MediaPlayer rockplayer = MediaPlayer.create(kaaf.this, R.raw.cake);
                rockplayer.start();
            }
            try {
                Thread.sleep(3000);
